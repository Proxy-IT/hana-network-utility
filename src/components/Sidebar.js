    ...
    <aside style={s.sidebar}>
      ...
      <div style={s.bottom}>
        ...
        <div style={s.versionRow}>
          ...
          <span style={s.versionNum}>v1.3.0</span>
        </div>
      </div>
    </aside>
  );
...
const s = {
  ...
  brand: { display: 'flex', alignItems: 'center', gap: 14, padding: '22px 18px 18px', WebkitAppRegion: 'drag' },
  logoWrap: { position: 'relative', width: 28, height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  logoOuter: { position: 'relative', width: 24, height: 24, display: 'flex', alignItems: 'center', justifyContent: 'center' },
  pulseRing: { position: 'absolute', width: 20, height: 20, borderRadius: '50%', border: '1.5px solid #00D4FF', animation: 'pulse-ring 2s ease-out infinite' },
  pulseDot: { width: 8, height: 8, borderRadius: '50%', background: '#00D4FF', boxShadow: '0 0 8px rgba(0,212,255,0.6)', animation: 'pulse-dot 2s ease-in-out infinite', zIndex: 1 },
  brandText: { display: 'flex', flexDirection: 'column', gap: 2 },
  brandName: { fontSize: 18, fontWeight: 600, color: '#E8EDF5', letterSpacing: '-0.02em', lineHeight: 1 },
  ...
  nav: { flex: 1, display: 'flex', flexDirection: 'column', padding: '12px 10px', gap: 2, WebkitAppRegion: 'no-drag' },
  ...
  sysRow: { display: 'flex', justifyContent: 'space-between', padding: '3px 20px', fontSize: 11 },
  ...
  versionRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 20px 0' },
